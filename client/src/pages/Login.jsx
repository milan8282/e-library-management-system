      ...
      <div className="grid w-full max-w-5xl overflow-hidden rounded-[32px] border border-white/70 bg-white/80 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl lg:grid-cols-2">
        <div className="hidden bg-slate-900 p-10 text-white lg:block">
          ...
          <h1 className="mt-6 text-4xl font-semibold leading-tight">
            Manage your library with clarity and control.
          </h1>
          <p className="mt-5 max-w-md text-slate-300">
            Access books, track borrowing, and run your digital library from a clean premium workspace.
          </p>

          <div className="mt-10 space-y-4">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
              <p className="text-sm text-slate-300">Fast access</p>
              <p className="mt-2 text-lg font-medium text-white">Jump directly into your library dashboard</p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
              <p className="text-sm text-slate-300">Organized workflow</p>
              <p className="mt-2 text-lg font-medium text-white">Keep books, users, and returns in sync</p>
            </div>
          </div>
        </div>
